...
class EnFunc
{
     ...
     * @var int
     */
    public $ob_function = 2;
    /**
     * 混淆函数产生变量最大长度
     * @var int
     */
    public $ob_function_length = 3;
    /**
     ...
     * @var int
     */
    public $encode_str_length = 3;
    /**
     * 混淆html 1=混淆 0=不混淆
     * @var int
     */
    public $encode_html = 1;
    /**
     * 混淆数字 1=混淆为0x00a 0=不混淆
     * @var int
     */
    public $encode_number = 1;
    /**
     ...
     * @var int
     */
    public $remove_comment = 1;
    /**
     * 文件头部增加的注释
     * @var string
     */
    public $comment = 'PHP Code Confusion + Encryption Project tinymeng/enphp';
    /**
     * debug
     * @var int
     */
